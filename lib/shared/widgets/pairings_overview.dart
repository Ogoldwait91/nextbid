      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Count: $total ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Avg credit: ${avgCredit.toStringAsFixed(1)}",
            ),
            ...
            Wrap(
              ...
              children:
                  topRegions
                      ...
                      .map(
                        (e) => Chip(
                          label: Text("${e.key} ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ ${e.value}"),
            ...
            if (show.isEmpty)
              ...
              ...show.map((p) {
                ...
                return ListTile(
                  ...
                  title: Text("$id"),
                  subtitle: Text(
                    "Credit $cr ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ $ngt night(s) ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ $rg",
                  ),
                );
              }),
          ],
