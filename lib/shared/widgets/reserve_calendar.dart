...
/// - Shows a month grid (MonÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œSun), highlights days for the selected reserve block.
...
class ReserveBlocksCalendar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Set<int> days =
        ((selected["days"] as List?) ?? const <int>[])
            .cast<num>()
            .map((e) => e.toInt())
            .toSet();
                ...
                IconButton(
                  ...
                  onPressed:
                      blocks.isEmpty
                          ...
                          : () {
                            final next =
                                (inx - 1 + blocks.length) % blocks.length;
                            onIndexChanged(next);
                          },
