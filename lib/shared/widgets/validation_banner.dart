              ...
              children: [
                const Row(
                  children: [
                    ...
                    SizedBox(width: 8),
                    Text("Please fix these before export", style: TextStyle(fontWeight: FontWeight.w600)),
                  ],
                ),
                const SizedBox(height: 8),
                ...preview.map((e) => Text("• $e", style: const TextStyle(color: Colors.red))),
                ...
                if (v.errors.length > preview.length)
                  Align(
                    ...
                    child: TextButton(
                      ...
                      child: Text("View ${v.errors.length - preview.length} more…"),
                    ),
                  ),
              ],
            ),
