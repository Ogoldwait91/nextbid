...
Future<void> serverExportRawDebug(String text, {String baseUrl = "http://127.0.0.1:8000"}) async {
  ...
  final fname = "nextbid_export_${now.year}-${now.month.toString().padLeft(2, "0")}.jss";
