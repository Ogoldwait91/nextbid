      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                FilledButton.icon(onPressed: () => _copy(context), icon: const Icon(Icons.copy), label: const Text("Copy commands")),
                const SizedBox(width: 8),
                OutlinedButton.icon(onPressed: () {}, icon: const Icon(Icons.description_outlined), label: const Text("Export (coming soon)")),
              ],
            ),
          ],
        ),
