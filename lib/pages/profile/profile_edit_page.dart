...
class _ProfileEditPageState extends State<ProfileEditPage> {
  ...
  @override
  void dispose() {
    _name.dispose(); _email.dispose(); _fleet.dispose(); _base.dispose(); _rank.dispose();
    super.dispose();
  }
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          TextField(controller: _fleet, decoration: const InputDecoration(labelText: 'Fleet (e.g., A350)')),
          const SizedBox(height: 12),
          TextField(controller: _base, decoration: const InputDecoration(labelText: 'Base (e.g., LHR)')),
          const SizedBox(height: 12),
          TextField(controller: _rank, decoration: const InputDecoration(labelText: 'Rank (e.g., FO/Capt)')),
